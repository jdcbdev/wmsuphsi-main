...
function sendSlotConfirmation($userEmail, $token, $firstname, $event_title, $event_banner) 
{
    ...
    <body>
      <div class="wrapper">
        ...
        <a href="http://localhost/wmsuphsi-main/controllers/slot_confirmation.php?token=' . $token . '" style="color: #107869; background: white; border: 1px solid #107869; border-radius: 2px; ">CONFIRM MY SLOT</a>
