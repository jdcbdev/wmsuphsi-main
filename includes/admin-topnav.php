...
<header class="navbar navbar-expand-md navbar-dark sticky-top background-color-green-visible shadow-sm py-0">
        ...
        <span class="ms-2 logo-name">PHSI</span>
        
        <?php  } else if($_SESSION['role'] == 'unesco_admin' || ($_SESSION['role'] == 'phsi_content_admin' && $_SESSION['role'] != 'super_admin')) { ?>
        <img class="logo-icon" src="../images/logos/new-unesco.png" alt="">
        <span class="ms-2 logo-name">UNESCO</span>
        <?php  }  ?>
