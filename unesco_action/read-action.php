...
<?php
    ...
    <td><?php echo $value['unesco_type'] ?></td>
    <td><img src="../uploads/<?php echo $value['filename']; ?>" alt="<?php echo $value['unesco_title']; ?>" style="width: 50%;"></td>
    <td><?php echo $value['unesco_title'] ?></td>
    <td><?php echo $value['unesco_details'] ?></td>
</tr>
<?php
$i++;
//end of loop
