...
<div class="admin-modal-content">
    ...
    <form id="editform" class="form-class" method="post" enctype="multipart/form-data">
        ...
        <label for="edit_type" class="form-label">Call for Action | Type</label>
            <div class="input-group">
                <select name="edit_type" id="edit_type" required>
                    <option value="<?php echo $value['action_type']; ?>">Call for Donations</option>
                    <option value="<?php echo $value['action_type']; ?>">Call for Volunteers</option>
                </select>
            </div>
        ...
        <div class="input-group">
            <input class="form-control" type="text" name="edit_title" id="edit_title" value="<?php echo $value['title']; ?>" required>
        </div>

        <!--EDIT IMAGE--> 
        <label for="file">Upload Image</label>
        <div class="hidden-preview">
            <img id="current-file-preview" src="../uploads/<?php echo $value['filename']; ?>" alt="<?php echo $value['title']; ?>">
        </div>
