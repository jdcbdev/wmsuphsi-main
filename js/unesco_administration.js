...
$(document).ready(function(e){
    ...
    $('#addform').on('submit', function(e){
        ...
        $.ajax({
            url: "../unesco_administration/create-admin.php",
            type: "POST",
...
function fetch(){
    $.ajax({
        url: '../unesco_administration/read-admin.php',
        type: 'post',
        success: function(response){
            $('#fetch').html(response);
        }
...
$(document).on('click', '#delete', function(e){
    ...
    if(window.confirm('Are you sure you want to delete the record?'))
    {
        ...
        $.ajax({
            url: '../unesco_administration/delete-admin.php',
            type: 'post',
...
$(document).on('click', '#edit', function(e){
    ...
    $.ajax({
        url: '../unesco_administration/edit-admin.php',
        type: 'post',
...
$(document).on('submit', '#editform', function(e){
    ...
    $.ajax({
        url: "../unesco_administration/update-admin.php",
        type: "POST",
        data:  new FormData(this),
        contentType: false,
        cache: false,
