...
$(document).ready(function(e){
    ...
    $('#addform').on('submit', function(e){
        ...
        $.ajax({
            url: "../unesco_history/create-history.php",
            type: "POST",
...
function fetch(){
    $.ajax({
        url: '../unesco_history/read-history.php',
        type: 'post',
        success: function(response){
            $('#fetch').html(response);
        }
...
$(document).on('click', '#delete', function(e){
    ...
    if(window.confirm('Are you sure you want to delete the record?'))
    {
        ...
        $.ajax({
            url: '../unesco_history/delete-history.php',
            type: 'post',
...
$(document).on('click', '#edit', function(e){
    ...
    $.ajax({
        url: '../unesco_history/edit-history.php',
        type: 'post',
...
$(document).on('submit', '#editform', function(e){
    ...
    $.ajax({
        url: "../unesco_history/update-history.php",
        type: "POST",
        data:  new FormData(this),
        contentType: false,
        cache: false,
