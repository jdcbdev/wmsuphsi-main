...
$(document).ready(function(e){
    ...
    $('#addform').on('submit', function(e){
        ...
        $.ajax({
            url: "../unesco_carousel/create-carousel.php",
            type: "POST",
...
function fetch(){
    $.ajax({
        url: '../unesco_carousel/read-carousel.php',
        type: 'post',
        success: function(response){
            $('#fetch').html(response);
        }
...
$(document).on('click', '#delete', function(e){
    ...
    if(window.confirm('Are you sure you want to delete the record?'))
    {
        ...
        $.ajax({
            url: '../unesco_carousel/delete-carousel.php',
            type: 'post',
...
$(document).on('click', '#edit', function(e){
    ...
    $.ajax({
        url: '../unesco_carousel/edit-carousel.php',
        type: 'post',
...
$(document).on('submit', '#editform', function(e){
    ...
    $.ajax({
        url: "../unesco_carousel/update-carousel.php",
        type: "POST",
        data:  new FormData(this),
        contentType: false,
        cache: false,
