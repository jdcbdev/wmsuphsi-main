...
$(document).ready(function(e){
    ...
    $('#addform').on('submit', function(e){
        ...
        $.ajax({
            url: "../phsi_action/create-action.php",
            type: "POST",
...
function fetch(){
    $.ajax({
        url: '../phsi_action/read-action.php',
        type: 'post',
        success: function(response){
            $('#fetch').html(response);
        }
...
$(document).on('click', '#delete', function(e){
    ...
    if(window.confirm('Are you sure you want to delete the record?'))
    {
        ...
        $.ajax({
            url: '../phsi_action/delete-action.php',
            type: 'post',
...
$(document).on('click', '#edit', function(e){
    ...
    $.ajax({
        url: '../phsi_action/edit-action.php',
        type: 'post',
...
$(document).on('submit', '#editform', function(e){
    ...
    $.ajax({
        url: "../phsi_action/update-action.php",
        type: "POST",
        data:  new FormData(this),
        contentType: false,
        cache: false,
