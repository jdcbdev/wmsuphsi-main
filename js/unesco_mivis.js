...
$(document).ready(function(e){
    ...
    $('#addform').on('submit', function(e){
        ...
        $.ajax({
            url: "../unesco_misvis/create-misvis.php",
            type: "POST",
...
function fetch(){
    $.ajax({
        url: '../unesco_misvis/read-misvis.php',
        type: 'post',
        success: function(response){
            $('#fetch').html(response);
        }
...
$(document).on('click', '#delete', function(e){
    ...
    if(window.confirm('Are you sure you want to delete the record?'))
    {
        ...
        $.ajax({
            url: '../unesco_misvis/delete-misvis.php',
            type: 'post',
...
$(document).on('click', '#edit', function(e){
    ...
    $.ajax({
        url: '../unesco_misvis/edit-misvis.php',
        type: 'post',
...
$(document).on('submit', '#editform', function(e){
    ...
    $.ajax({
        url: "../unesco_misvis/update-misvis.php",
        type: "POST",
        data:  new FormData(this),
        contentType: false,
        cache: false,
