...
<div class="signup">
  <div class="signup-container">
    ...
    <div class="sub-title">Personal Information</div>
      <form action="signup-employee.php" method="post" enctype="multipart/form-data">

        <div class="user-details">

        <input type="hidden" id="member_type" name="member_type" value="Employee">
        ...
        <div class="sub-title">Upload Employee ID (Front)</div><br>
        ...
        <div class="sub-title">Upload Employee ID (Back)</div><br>
        <div class="input-group">
