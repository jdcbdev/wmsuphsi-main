...
<div class="signup">
  <div class="signup-container">
    ...
    <div class="title">Sign up form for </div>
    
    <div class="content">

    <!--PERSONAL INFORMATION-->
    <div class="sub-title">Personal Information</div>
      <form action="signup-other.php" method="post" enctype="multipart/form-data">

        <div class="user-details">

        <input type="hidden" id="member_type" name="member_type" value="None">
        ...
        <div class="sub-title">Upload any valid ID</div><br>
