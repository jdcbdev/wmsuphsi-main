<?php
    ...
    */
    ...
    $page_title = 'Call for Actions | WMSU - UNESCO';
    $unesco_action = 'active';
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-9 col-xl-10 p-md-4">
                <div class="w-100">
                    <h5 class="col-12 fw-bold mb-3 mt-3 mt-md-0">Call for Actions | WMSU UNESCO Club</h5>
...
<div id="add-modal" class="admin-modal">
    <div class="admin-modal-content">
        ...
        <form id="addform" class="form-class" method="post" enctype="multipart/form-data">
            ...
            <label for="unesco_type" class="form-label">Call for Action | Type</label>
            <div class="input-group">
                <select name="unesco_type" id="unesco_type" required>
                    <option value="Call for Donations" >Call for Donations</option>
                    <option value="Call for Volunteers">Call for Volunteers</option>
                </select>
            </div>

            <label for="unesco_title" class="form-label">Title</label>
            <div class="input-group">
                <input class="form-control" type="text" name="unesco_title" id="unesco_title" required>
            </div>
            ...
            <label for="unesco_details" class="form-label">Details</label>
            <div class="input-group">
                <textarea class="form-control" type="text" name="unesco_details" id="unesco_details" rows="4" cols="50" required> </textarea>
            </div>
...
<script src="../js/unesco_action.js"></script>
