    ...
    <div class="modal-content">
        ...
        <form id="addform" class="form-class" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <input class="form-control" type="text" name="misvis_title" id="misvis_title" required>
            </div>
            ...
            <label for="misvis_description" class="form-label">Image Description</label>
            <div class="input-group">
                <textarea class="form-control" type="text" name="misvis_description" id="misvis_description" rows="4" cols="50" required> </textarea>
            </div>
...
<script src="../js/misvis.js"></script>
