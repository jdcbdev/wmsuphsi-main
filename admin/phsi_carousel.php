                ...
                <div class="w-100">
                    ...
                    <ul class="nav nav-tabs application">
                        ...
                        <li class="nav-item active" id="li-pending">
                            <a class="nav-link">Carousel<span class="counter" id="counter-all">3</span></a>
                        </li>
                    ...
                    <div class="input-group search-keyword col-12 flex-lg-grow-1">
                        <input type="text" name="keyword" id="keyword" placeholder="Search Title" class="form-control">
