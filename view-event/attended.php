<?php require_once 'filter.php'; ?>
    ...
    $listOfAttendees = $rsvp->getAttended($rsvp->event_id);
        ...
        <tr>
            <!--<td>
                <div class="action-button">
                    <a name="confirm_attendance" type="submit" class="me-2 green" id="confirm_attendance" value="#"><i class='bx bx-send' ></i>Send Feedback Form</a>
                </div>
            </td>-->
